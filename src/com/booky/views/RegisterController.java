    ...
    private void validateRegister(ActionEvent event) {
        if (firstnameField.getText().isEmpty() || lastnameField.getText().isEmpty() || emailField.getText().isEmpty() || passwordField.getText().isEmpty() || confirmpassField.getText().isEmpty()) {
            ...
            if (!matcher.matches()) {
                ...
                Customer c = new Customer(firstnameField.getText(), lastnameField.getText(), age, emailField.getText(), addressField.getText(), teleField.getText(), imgLabel.getText(), passwordField.getText(), new Role(2, "Customer"));
